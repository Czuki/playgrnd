...
class SpaceAgeTest(unittest.TestCase):
    def test_age_on_earth(self):
        self.assertEqual(SpaceAge.on_earth(1000000000), 31.69)

    def test_age_on_mercury(self):
        self.assertEqual(SpaceAge.on_mercury(2134835688), 280.88)

    def test_age_on_venus(self):
        self.assertEqual(SpaceAge.on_venus(189839836), 9.78)
